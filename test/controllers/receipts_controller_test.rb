...
class ReceiptsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create receipt' do
    assert_difference('Receipt.count') do
      post receipts_url,
           params: { receipt: { customer_id: @receipt.customer_id, discount_amt: @receipt.discount_amt,
                                gross_amt: @receipt.gross_amt, net_amt: @receipt.net_amt, receipt_type: @receipt.receipt_type } }
    end
